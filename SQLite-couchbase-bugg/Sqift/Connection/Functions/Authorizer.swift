...
extension Connection {
    ...
    typealias Authorizer = (AuthorizerAction, String?, String?, String?, String?) -> AuthorizerResult
    ...
    func authorizer(_ authorizer: Authorizer?) throws {
        ...
        let result = sqlite3_set_authorizer(
            handle, { boxPointer, action, p1, p2, p3, p4 in
