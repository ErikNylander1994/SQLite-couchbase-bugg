...
extension Connection {
    ...
    typealias Collation = (_ lhs: String, _ rhs: String) -> ComparisonResult
    ...
    func createCollation(named name: String, collate: @escaping Collation) {
        ...
        let result = sqlite3_create_collation_v2(
            ...
            name,
            SQLITE_UTF8,
            boxPointer, {(boxPointer: UnsafeMutableRawPointer?, lhsCount, lhsBytes, rhsCount, rhsBytes) in
