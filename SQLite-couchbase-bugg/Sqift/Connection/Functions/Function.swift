...
extension Connection {
    ...
    typealias ScalarFunction = (ScalarFunctionContext, [FunctionValue]) -> FunctionResult
    ...
    throws {
        ...
        try check(
            sqlite3_create_function_v2(
                ...
                nArg,
                flags,
                Unmanaged<ScalarFunctionBox>.passRetained(box).toOpaque(), {(context: OpaquePointer?, count: Int32, values: UnsafeMutablePointer<OpaquePointer?>?) in
                ...
                nil,
                nil, {(boxPointer: UnsafeMutableRawPointer?) in
    ...
    func removeFunction(named name: String, argumentCount: Int8) throws {
        let nArg = argumentCount < 0 ? -1 : Int32(argumentCount)
...
extension Connection {
    ...
    typealias AggregateContextObjectFactory = () -> AnyObject
    ...
    typealias AggregateStepFunction = (AggregateFunctionContext, [FunctionValue]) -> Void
    
    /// A closure representing a SQLite aggregate final function that takes an aggregate function context and returns
    /// a function result.
    typealias AggregateFinalFunction = (AggregateFunctionContext) -> FunctionResult
    ...
    throws {
        ...
        try check(
            sqlite3_create_function_v2(
                ...
                nil, {(context: OpaquePointer?, count: Int32, values: UnsafeMutablePointer<OpaquePointer?>?) in
...
extension Connection {
    ...
    struct FunctionValue {
        ...
        var integer: Int32 { return sqlite3_value_int(value) }
        ...
        var long: Int64 { return sqlite3_value_int64(value) }
        ...
        /// result is floor'd if the underlying value is a double.
        var double: Double { return sqlite3_value_double(value) }
        
        /// Returns the function value as a string.
        var text: String { return String(cString: sqlite3_value_text(value)) }
        
        /// Returns the function value as data.
        var data: Data { return Data(bytes: blob, count: byteLength) }
        
        /// Returns the function value as a buffer.
        var buffer: UnsafeRawBufferPointer { return UnsafeRawBufferPointer(start: blob, count: byteLength) }
        ...
        var type: DataType { return DataType(sqlite3_value_type(value)) }
...
extension Connection {
    ...
    class ScalarFunctionContext {
        ...
        struct AuxilaryData {
            ...
            subscript(index: Int32) -> AnyObject? {
                get {
                ...
                set {
                    ...
                    if let newValue = newValue {
                        sqlite3_set_auxdata(
                            context,
                            index,
                            Unmanaged.passRetained(newValue).toOpaque(), {(valuePointer: UnsafeMutableRawPointer?) in
...
extension Connection {
    ...
    class AggregateFunctionContext {
        ...
        var stepObject: AnyObject { return aggregateContextObject()! }
        ...
        var finalObject: AnyObject? { return aggregateContextObject() }
