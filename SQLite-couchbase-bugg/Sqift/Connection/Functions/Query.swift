...
extension Connection {
    ...
    func query<T: Extractable>(_ sql: SQL, _ parameters: Bindable?...) throws -> T? {
    ...
    ///
    /// - Throws: A `SQLiteError` if SQLite encounters and error in the prepare, bind, step, or data extraction process.
    func query<T: Extractable>(_ sql: SQL, _ parameters: [String: Bindable?]) throws -> T? {
        return try prepare(sql).bind(parameters).query()
    }
    ...
    ///
    /// - Throws: A `SQLiteError` if SQLite encounters and error in the prepare, bind, step, or data extraction process.
    func query(_ sql: SQL, _ parameters: Bindable?...) throws -> Row? {
        return try prepare(sql).bind(parameters).query()
    }
    ...
    ///
    /// - Throws: A `SQLiteError` if SQLite encounters and error in the prepare, bind, step, or data extraction process.
    func query(_ sql: SQL, _ parameters: [String: Bindable?]) throws -> Row? {
        return try prepare(sql).bind(parameters).query()
    }
    ...
    ///
    /// - Throws: A `SQLiteError` if SQLite encounters and error in the prepare, bind, step, or data extraction process.
    func query<T: ExpressibleByRow>(_ sql: SQL, _ parameters: Bindable?...) throws -> T? {
        return try prepare(sql).bind(parameters).query()
    }
    ...
    ///
    /// - Throws: A `SQLiteError` if SQLite encounters and error in the prepare, bind, step, or data extraction process.
    func query<T: ExpressibleByRow>(_ sql: SQL, _ parameters: [String: Bindable?]) throws -> T? {
        return try prepare(sql).bind(parameters).query()
    }
    ...
    ///
    /// - Throws: A `SQLiteError` if SQLite encounters and error in the prepare, bind, step, or data extraction process.
    func query<T>(_ sql: SQL, _ parameters: Bindable?..., body: (Row) throws -> T) throws -> T? {
    ...
    ///
    /// - Throws: A `SQLiteError` if SQLite encounters and error in the prepare, bind, step, or data extraction process.
    func query<T>(_ sql: SQL, _ parameters: [String: Bindable?], body: (Row) throws -> T) throws -> T? {
        return try prepare(sql).bind(parameters).query(body)
    }
