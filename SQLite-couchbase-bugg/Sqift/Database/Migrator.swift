...
internal class Migrator {
    ...
    let desiredSchemaVersion: UInt64
    ...
    var migrationRequired: Bool { return currentSchemaVersion < desiredSchemaVersion }
    ...
    init(connection: Connection, desiredSchemaVersion: UInt64) {
