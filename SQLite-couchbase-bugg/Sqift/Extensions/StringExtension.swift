...
extension String {
    ...
    var sqift: StringExtension { return StringExtension(string: self) }
}
...
struct StringExtension {
    ...
    /// Returns a new SQL `String` made by adding single quotes around the `String` and escaping single quotes.
    ///
    /// - Returns: The new escaped `String`.
    func addingSQLEscapes() -> String {
