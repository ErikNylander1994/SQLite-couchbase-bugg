...
/// generic methods to extract values from the database. OBS MESTADELS ETT INTERNT DELA DEPENDENCY, DÄRAV DOKUMENTATION PÅ ENGELSKA OBS
public struct Row {
    ...
    var columnCount: Int { return statement.columnCount }
    ...
    public subscript<T: Extractable>(columnIndex: Int) -> T { get throws { return try value(at: columnIndex)! } }
    public subscript(columnIndex: Int) -> Date {
        get throws {
            guard let val: Double = try value(at: columnIndex) else {
    ...
    public subscript<T: Extractable>(columnName: String) -> T { get throws { return try value(forColumnName: columnName)! } }
    ...
    func value(at columnIndex: Int) -> Any? {
        var value: Any?
    ...
    ///
    /// - Returns: The value at the specified column index.
    func value<T: Extractable>(at columnIndex: Int) throws -> T? {
    ...
    func value<T: Extractable>(forColumnName columnName: String) throws -> T? {
