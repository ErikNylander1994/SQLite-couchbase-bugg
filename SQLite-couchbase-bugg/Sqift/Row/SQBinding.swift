...
/// (EJ DELA CENTRAL) Used to store a `Bindable` value representation prior to binding a parameter to a `Statement`. OBS MESTADELS ETT INTERNT DELA DEPENDENCY, DÄRAV DOKUMENTATION PÅ ENGELSKA OBS
///
...
var bindingDateFormatter: DateFormatter = {
...
protocol CodableBinding: Codable, SQBinding {}
...
extension CodableBinding where BindingType == Data {
    ...
    static func fromBindingValue(_ value: Any) throws -> Self? {
...
struct ArrayBinding<T: Codable>: CodableBinding, ExpressibleByArrayLiteral {
    /// The binding type of a parameter to bind to a statement.
...
struct SetBinding<T: Hashable & Codable>: CodableBinding, ExpressibleByArrayLiteral {
    /// The binding type of a parameter to bind to a statement.
    typealias BindingType = Data
...
struct DictionaryBinding<Key: Hashable & Codable, Value: Codable>: CodableBinding, ExpressibleByDictionaryLiteral {
    /// The binding type of a parameter to bind to a statement.
    typealias BindingType = Data
